...
export default function MapScreen() {
  ...
  return (
    <View style={[styles.container, dark && { backgroundColor: Colors.TEXT }]}>
      <Text style={[styles.title, dark && { color: Colors.BACKGROUND }]}>🗺️ מפת בטומי</Text>
      <Text style={[styles.sub, dark && { color: Colors.SECONDARY }]}>בקרוב — מפה אינטראקטיבית עם כל הנקודות</Text>
    </View>
  );
}
