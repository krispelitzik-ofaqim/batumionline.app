...
const s = StyleSheet.create({
  btn: { width: '100%', marginTop: 10, marginBottom: 14, paddingVertical: 16, paddingHorizontal: 14, borderRadius: 14, backgroundColor: '#F4A94E', flexDirection: 'row-reverse', alignItems: 'center', gap: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.15, shadowRadius: 4, elevation: 3 },
  btnIcon: { fontSize: 22 },
