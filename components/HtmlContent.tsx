  ...
  return h
    .replace(/style="([^"]*)"/g, (_m, body) => {
      const keep = (body as string)
        ...
        .filter(s => !/text-align\s*:\s*(justify|left|center|right)/i.test(s))
        .join(';');
...
<style>
.hc-rtl-content, .hc-rtl-content * { direction: ${D} !important; text-align: ${A} !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif !important; box-sizing: border-box !important; }
.hc-rtl-content { font-size: 15px !important; line-height: 1.7 !important; letter-spacing: 0.1px !important; }
.hc-rtl-content p { margin: 0 0 14px 0 !important; line-height: 1.7 !important; padding: 0 !important; text-align: ${A} !important; }
...
.hc-rtl-content h2 { font-size: 18px !important; font-weight: 800 !important; margin: 20px 0 10px 0 !important; line-height: 1.3 !important; padding: 0 !important; position: relative !important; padding-${S}: 14px !important; }
.hc-rtl-content h2::before { content: "" !important; position: absolute !important; ${S}: 0 !important; top: 6px !important; bottom: 6px !important; width: 4px !important; background: currentColor !important; border-radius: 2px !important; opacity: 0.5 !important; }
...
.hc-rtl-content ul, .hc-rtl-content ol { margin: 8px 0 14px 0 !important; padding-${S}: 22px !important; padding-${E}: 0 !important; }
.hc-rtl-content li { margin: 0 0 8px 0 !important; line-height: 1.65 !important; padding-${S}: 4px !important; }
...
.hc-rtl-content blockquote { border-${S}: 3px solid #3DA5C4 !important; background: #f0f7fa !important; padding: 10px 14px !important; margin: 12px 0 !important; border-radius: 8px !important; font-style: italic !important; color: #475569 !important; }
...
.hc-rtl-content th, .hc-rtl-content td { border: 1px solid #e2e8f0 !important; padding: 8px !important; text-align: ${A} !important; }
    ...
    return (
      <View style={style}>
        {React.createElement('div', {
          ...
          style: { direction: D, textAlign: A, ...(baseStyle as any) },
        })}
      </View>
    );
  }
  ...
  return (
    <View style={[{ width: '100%', alignSelf: 'stretch' }, style]}>
      <RenderHtml
        ...
        defaultTextProps={{ style: { textAlign: A, writingDirection: D }, allowFontScaling: false }}
        enableExperimentalMarginCollapsing
        tagsStyles={{
          body: { textAlign: A, writingDirection: D, alignSelf: 'stretch', width: '100%' },
          div: { textAlign: A, writingDirection: D, alignSelf: 'stretch', width: '100%' },
          p: { marginBottom: 10, textAlign: A, writingDirection: D, alignSelf: 'stretch', width: '100%' },
          h1: { fontSize: 22, fontWeight: '900', marginBottom: 10, textAlign: A, writingDirection: D, alignSelf: 'stretch', width: '100%' },
          h2: { fontSize: 18, fontWeight: '800', marginBottom: 8, textAlign: A, writingDirection: D, alignSelf: 'stretch', width: '100%' },
          h3: { fontSize: 16, fontWeight: '800', marginBottom: 6, textAlign: A, writingDirection: D, alignSelf: 'stretch', width: '100%' },
          ul: { marginBottom: 10, textAlign: A, alignSelf: 'stretch', width: '100%' },
          li: { marginBottom: 4, textAlign: A, writingDirection: D },
          a: { color: '#1A6B8A', textDecorationLine: 'underline', writingDirection: D },
          span: { writingDirection: D },
